...
if ( ! function_exists( 'karma_fonts_url' ) ) {
	function karma_fonts_url() {
		 ...
		 */
		if ( 'off' !== esc_html_x( 'on', 'Google font: on or off', 'eno' ) ) {
			$fonts = array(
...
add_action( 'admin_enqueue_scripts', function(){
	wp_enqueue_style('karma-fonts', karma_fonts_url(), array(), '1.0.0' );
	wp_enqueue_style('gutenberg-admin', TRUETHEMES_CSS . '/gutenberg-admin.min.css');
}, 99 );
