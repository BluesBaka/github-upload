...
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'karma_metaboxes' ) ) :

	function karma_metaboxes() {
		$hidemetabox = get_option('ka_hidemetabox');
		if( $hidemetabox == "true" ) {
...
/*-----------------------------------------------------------------------------------*/
if ( ! function_exists( 'karma_css_hide_slug_metabox' ) ) :
...
if($blog_image_frame == 'shadow'){
	$html .= '<div class="shadow_img_frame tt-blog-featured" itemprop="image">';
}else{
	$html .= '<div class="modern_img_frame tt-blog-featured" itemprop="image">';
}
...
if(is_multisite()):
		...
		if(!function_exists('tt_style_wp_activate_php')):
			...
			//gutenberg
			wp_enqueue_style( 'karma-gutenberg', TRUETHEMES_CSS . '/gutenberg.min.css');
