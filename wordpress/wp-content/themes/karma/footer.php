        ...
        <div id="footer_bottom">
            <div class="info">
                ...
                <div id="foot_left">&nbsp;<?php truethemes_begin_footer_left_hook();// action hook ?>
                    <?php
                    $theme_mods_Karma = get_option('theme_mods_Karma');
                        if(is_active_sidebar(12)): dynamic_sidebar("Footer Copyright - Left Side");
                        elseif(!is_child_theme() && get_theme_mod('footer_copyright_textbox')): echo $theme_mods_Karma['footer_copyright_textbox'];
                        elseif(is_child_theme() && get_theme_mod('footer_copyright_textbox')): echo get_theme_mod('footer_copyright_textbox');
						else:
